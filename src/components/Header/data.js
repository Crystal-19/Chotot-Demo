export const iconsMix = [
  {
    image: { avatar: true, src: 'https://static.chotot.com/storage/chotot-icons/svg/escrow-orders.svg'},
...
export const iconsGold = [
  ...
  {
    image: 'https://st.chotot.com/storage/chotot-icons/svg/circle-list.svg',
...
export const iconsGreen = [
  ...
  },
  {
    ...
    content: 'Download the app for free'
  }
]
...
export const iconsGray = [
  ...
  {
    image: 'https://st.chotot.com/storage/chotot-icons/svg/sign-out.svg',
    content: 'Log out'
  }
]
